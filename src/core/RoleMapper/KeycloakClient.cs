...
namespace Keycloak.Net
{
    ...
    {
        public async Task<Mapping> GetRoleMappingsForGroupAsync(string realm, string groupId) => await GetBaseUrl()
        ...
        public async Task<IEnumerable<Role>> GetAvailableRealmRoleMappingsForGroupAsync(string realm, string groupId) => await GetBaseUrl()
            .AppendPathSegment($"/admin/realms/{realm}/groups/{groupId}/role-mappings/realm/available")
            .GetJsonAsync<IEnumerable<Role>>()
            .ConfigureAwait(false);

        public async Task<IEnumerable<Role>> GetEffectiveRealmRoleMappingsForGroupAsync(string realm, string groupId) => await GetBaseUrl()
            .AppendPathSegment($"/admin/realms/{realm}/groups/{groupId}/role-mappings/realm/composite")
            .GetJsonAsync<IEnumerable<Role>>()
            .ConfigureAwait(false);

        public async Task<Mapping> GetRoleMappingsForUserAsync(string realm, string userId) => await GetBaseUrl()
        ...
        public async Task<IEnumerable<Role>> GetRealmRoleMappingsForUserAsync(string realm, string userId) => await GetBaseUrl()
            .AppendPathSegment($"/admin/realms/{realm}/users/{userId}/role-mappings/realm")
            .GetJsonAsync<IEnumerable<Role>>()
            .ConfigureAwait(false);
        ...
        public async Task<IEnumerable<Role>> GetAvailableRealmRoleMappingsForUserAsync(string realm, string userId) => await GetBaseUrl()
            .AppendPathSegment($"/admin/realms/{realm}/users/{userId}/role-mappings/realm/available")
            .GetJsonAsync<IEnumerable<Role>>()
            .ConfigureAwait(false);

        public async Task<IEnumerable<Role>> GetEffectiveRealmRoleMappingsForUserAsync(string realm, string userId) => await GetBaseUrl()
